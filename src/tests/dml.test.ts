...
const doAfter = async () => {
    try {
        ...
        expect.fail(`doAfter/dml: Should not have thrown '${error.message}'`);
    }
}
...
const doBefore = async () => {
    try {
        ...
        expect.fail(`doBefore/dml: Should not have thrown '${error.message}'`);
    }
}
...
const doBeforeEachCreateTable = async () => {
    ...
    try {
        ...
        expect.fail(`beforeEachCreateTable/dml: addTable should not have thrown '${error.message}'`);
    }
}
...
const doBeforeEachInsertRows = async () => {
    ...
    try {
        ...
        expect.fail(`beforeEachInsertRows/dml: insert should not have thrown '${error.message}'`);
    }
}
